 ...
 */
public class TelegramSubscribersPhoneNumSpecification implements ISqlSpecification {

    private static final String SQL_FIND_BY_PHONENUM = 
            new StringBuilder()
                    ...
                    .append(" WHERE ") .append(TelegramSubscriberVo.FIELD_PHONE_NUM).append("=? ")
            .toString();
            //"select * from PVIM_EXT_TELEGRAM_SUBSCRIBERS where phone_num=?";
    
    private final String phoneNumber;
    
    public TelegramSubscribersPhoneNumSpecification(String phoneNumber) {
        this.phoneNumber = phoneNumber;
    }
    
    @Override
    public String toParameterizedSqlQuery() {
        return SQL_FIND_BY_PHONENUM;
    }

    @Override
    public Object[] getSqlParams() {
        return (Object[])(new String[]{phoneNumber});
    }
