 ...
 */
package id.dni.pvim.ext.telegram.commons.sender;
...
public class MessageSender {
    ...
    public static boolean sendMessage(long chatID, String content) 
        ...
        Logger.getLogger(MessageSender.class.getName()).log(Level.WARNING, 
                    " >> SendMessage ({0}, {1})", new Object[]{chatID, content});
