    ...
    public ProviewLoginResponse login(ProviewLoginRequest request) {
        ...
        try {
            ...
            String soapXml
                    ...
                    + "<soapenv:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:res=\"http://soap.wincor-nixdorf.com/itmp/ResourceRelationshipService\">\n"
                    + "    <soapenv:Header>\n"
                    ...
                    + "   </soapenv:Header>\n"
                    + "   <soapenv:Body>\n"
                    + "      <res:findGroupResources soapenv:encodingStyle=\"http://schemas.xmlsoap.org/soap/encoding/\">\n"
                    + "         <groupName xsi:type=\"xsd:string\">?????????</groupName>\n"
                    + "      </res:findGroupResources>\n"
                    + "   </soapenv:Body>\n"
                    + "</soapenv:Envelope>";
...
//                    + "</soapenv:Envelope>";
            ...
            if (xmlReturn.contains("CMDSTAT_USER_LOGIN_FAILED") || xmlReturn.contains("CMDSTAT_USER_INVALID")) {
                ...
                if (xmlReturn.contains("SSOP_INVALID_PARAMETER(4)")
                        ...
                        || xmlReturn.contains("findGroupResourcesResponse")) {
